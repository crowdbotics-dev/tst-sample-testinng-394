"""
Django settings for tst_sample_testinng_394 project.
...
ROOT_URLCONF = 'tst_sample_testinng_394.urls'
...
WSGI_APPLICATION = 'tst_sample_testinng_394.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_sample_testinng_394 API",
    "DESCRIPTION": "API documentation for tst_sample_testinng_394 App",
    "VERSION": "v1",
}
